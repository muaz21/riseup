...
const CardNav = ({
  ...
  useLayoutEffect(() => {
    ...
    // If defaultOpen is true, play the timeline immediately
    if (defaultOpen && tl) {
      tl.play(0);
    }
    ...
    <div className={`card-nav-container ${className}`}>
      <nav ref={navRef} className={`card-nav ${isExpanded ? 'open' : ''}`} style={{ background: baseColor }}>
        <div className="card-nav-top">
          ...
          <div className="logo-container" style={hideHamburger ? { position: 'static', transform: 'none' } : {}}>
            {logoText ? (
              <h1 
                className="logo-text" 
                style={{
